...
/* A class that represents the operation that matches a specific character.
 */
class MatchChar : public RegexOperator {
    char matchChar;

public: 
    MatchChar(const char a) : matchChar(a) {};
    ~MatchChar() {}
...
/* A class that represents the operation that matches any character.
 */
...
/* A class that represents the operation that matches a subset of characters.
 */
class MatchFromSubset : public RegexOperator {
    string subset;
public: 
    MatchFromSubset(const string s) : subset(s) {};
    ~MatchFromSubset() {}

    bool match(const string &s, Range &r) const;
};

/* A class that represents the operation that matches any character not in 
 * a subset of characters.
 */
class ExcludeFromSubset : public RegexOperator {
    string subset;
public: 
    ExcludeFromSubset(const string s) : subset(s) {};
    ~ExcludeFromSubset() {}
